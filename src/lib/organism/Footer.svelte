...
<footer class="footer">
  <div class="footer__grid">
    <enhanced:img
      ...
      alt="logo van veronica in footer"
      width="200px"
      height="200px"
    />
    ...
    <ul class="footer__algemeen">
      ...
      <li class="footer__algemeen-links">
        <a href="/">DJ overzichtAlle programma's</a>
      </li>
